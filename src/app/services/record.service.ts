...
export class recordService {
    ...
    private urlGet = "https://localhost:5001/api/Record?Id=";
    private urlAll = "https://localhost:5001/api/Record/all?userId=";
    private urlAdd = "https://localhost:5001/api/Record";
